...
namespace Radial_BandUnB_noPX.MP_ATM_MDC
{
    public class LaplacianMethod : IDisposable
    {
        ...
        public virtual double GetLaplacian(double[] A_array, double[] A_Lap_array, double[] P_array, double[] P_Lap_array, double[] S_array, double[] S_Lap_array)
        {
            return 0d;
        }
    ...
    public class LaplacianMethod2 : LaplacianMethod
    {
        public LaplacianMethod2(double dr, int MaxPoints)
            : base(dr, MaxPoints) { }
        public override double GetLaplacian(double[] A_array, double[] A_Lap_array, double[] P_array, double[] P_Lap_array, double[] S_array, double[] S_Lap_array)
        {
