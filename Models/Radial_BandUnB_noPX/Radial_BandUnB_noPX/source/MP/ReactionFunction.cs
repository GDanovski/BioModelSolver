...
namespace Radial_BandUnB_noPX.MP_ATM_MDC
{
    public class ReactionFunction : IDisposable
    {
        ...
        public virtual double F_Xm(double AX)
        {
            return 0d;
        }
        public virtual double F_P(double AX, double P)
        {
            return 0d;
        }
    ...
    public class LogisticReactionFunction : ReactionFunction
    {
        ...
        public override double F_Xm(double AX)
        {
            // d_dt Xm = k_4 [PX]
            return SiteParams.k_3 * AX;
        }
        public override double F_P(double AX, double P)
        {
            // d_dt P = k_4 [PX] - k_d P [+ Lap(P)]
            return SiteParams.k_3 * AX - SiteParams.k_d * P;
