...
namespace Radial_BandUnB_noP_phosph.FRAP_ATM
{
    public class LaplacianMethod : IDisposable
    {
        ...
        public virtual double GetLaplacian(double[] Ad_array, double[] Ad_Lap_array,
            double[] Al_array, double[] Al_Lap_array)
        {
            return 0d;
        }
    ...
    public class LaplacianMethod2 : LaplacianMethod
    {
        public LaplacianMethod2(double dr, int MaxPoints)
            : base(dr, MaxPoints) { }
        public override double GetLaplacian(double[] Ad_array, double[] Ad_Lap_array,
            double[] Al_array, double[] Al_Lap_array)
        {
