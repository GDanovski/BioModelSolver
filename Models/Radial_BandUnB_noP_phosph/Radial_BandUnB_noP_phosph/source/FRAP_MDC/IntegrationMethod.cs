...
namespace Radial_BandUnB_noP_phosph.FRAP_MDC
{
    ...
    public class EulerIntegrationMethod : IntegrationMethod
    {
        ...
        public override void Increment()
        {
            ...
            TheLaplacianMethod.GetLaplacian(A_array, A_Lap_array, Sd_array, Sd_Lap_array, Sl_array, Sl_Lap_array);
            ...
            Parallel.ForEach(TheLaplacianMethod.LapPoints, (pr) =>
            {
                ...
                double dH_dt = TheReactionFunction.F_H(PX_array[jr],H_array[jr],Y_array[jr]);
                double dY_dt = TheReactionFunction.F_Y(PX_array[jr], H_array[jr], Ml_array[jr] + Md_array[jr], Y_array[jr], Sl_array[jr] + Sd_array[jr]);
