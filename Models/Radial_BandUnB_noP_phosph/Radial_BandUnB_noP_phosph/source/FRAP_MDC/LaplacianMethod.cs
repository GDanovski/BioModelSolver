...
namespace Radial_BandUnB_noP_phosph.FRAP_MDC
{
    public class LaplacianMethod : IDisposable
    {
        ...
        public virtual double GetLaplacian(double[] A_array, double[] A_Lap_array, double[] Sd_array, double[] Sd_Lap_array, double[] Sl_array, double[] Sl_Lap_array)
        {
            return 0d;
        }
    ...
    public class LaplacianMethod2 : LaplacianMethod
    {
        public LaplacianMethod2(double dr, int MaxPoints)
            : base(dr, MaxPoints) { }
        public override double GetLaplacian(double[] A_array, double[] A_Lap_array, double[] Sd_array, double[] Sd_Lap_array, double[] Sl_array, double[] Sl_Lap_array)
        {
