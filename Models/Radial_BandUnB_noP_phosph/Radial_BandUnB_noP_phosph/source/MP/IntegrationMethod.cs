...
namespace Radial_BandUnB_noP_phosph.MP_ATM_MDC
{
    ...
    public class EulerIntegrationMethod : IntegrationMethod
    {
        ...
        public override void Increment()
        {
            ...
            TheLaplacianMethod.GetLaplacian(A_array, A_Lap_array, S_array, S_Lap_array);
            ...
            Parallel.ForEach(TheLaplacianMethod.LapPoints, (pr) =>
            {
                ...
                double dY_dt = TheReactionFunction.F_Y(PX_array[jr], H_array[jr], M_array[jr],Y_array[jr], S_array[jr]);
